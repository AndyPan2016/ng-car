...
export class PersonnelManageComponent extends CustomPageOperationComponent implements OnInit {
  ...
  public status = {
    ...
    infoModel: [
      // 账号
      {
        value: null, text: '账号', key: 'userName', require: true, verifyType: 'specialCharacter'
      },
      // 姓名
      {
        value: null, text: '姓名', key: 'name', require: true, verifyType: 'specialCharacter'
      },
      // 邮箱
      {
      ...
      // 手机
      {
        value: null, text: '手机', key: 'phoneNumber', require: true, verifyType: 'phone'
      },
      // 部门
      {
